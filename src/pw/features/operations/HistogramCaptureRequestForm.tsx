...
import { DEFAULT_HISTOGRAM_SAMPLE_DURATION_SECONDS } from "@/pw/features/operations/operationDefaults";
...
interface HistogramCaptureRequestFormProps {
  ...
  requestDefaultsOverride?: Partial<HistogramCaptureFormValues>;
}
